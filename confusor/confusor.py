...
from utils.spec_func import same_last_hanzi_first_letter


CONFUSOR_DATA_DIR = '/data/chendian/'

# features from tencent embeddings (200-dim embeddings for 12M n-gram phrases)
...
CORPUS_PATH = f'{CONFUSOR_DATA_DIR}/tencent_embedding/pinyin2token_noname.pkl'  # remove name words (from stanfordNLP)
...
# features from tencent embeddings
TX_WORD_FREQ_PATH = f'{CONFUSOR_DATA_DIR}/tencent_embedding/word_freq.pkl'

# features from tencent corpus: word Frequency
ZI_FREQ_PATH = f'{CONFUSOR_DATA_DIR}/tencent_embedding/zi_freq.pkl'

# features from wc public articles
USE_WC_WORD_FREQ = True
WC_WORD_FREQ_PATH = f'{CONFUSOR_DATA_DIR}/wc_data_records/wc_word_frequency_score_01.pkl'  # zi + 1-gram word
...
class Confusor(object):
    ...
    def __init__(self, 
        ...
        self.spec_func = same_last_hanzi_first_letter
        ...
        self.word_freq = self.load_pickle(FREQ_PATH)
        self.word_2gram_freq = self.load_pickle(FREQ_PATH_2GRAM)
        self.wc_word_freq = {}
        self.wc_2gram_freq = {}
