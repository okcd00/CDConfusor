...
def is_chinese_phrase(phrase_str):
    # [deprecated] usage
    return is_pure_chinese_phrase(phrase_str)
...
def clean_text(text, change_special_punc=False):
    ...
    for char in text:
        ...
        if is_whitespace(char):
            output.append(" ")  # replace all kinds of blanks with basic blank
        elif change_special_punc:  # NEW
