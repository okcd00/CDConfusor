...
TRAIN_FILE=../data/cn/Wang271k_augw_ime/dcn_train.augw1.dcn.txt
...
OUTPUT_DIR=dcn_models/wsw_ime_train_model_192/
...
CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 python train_DCN.py \
