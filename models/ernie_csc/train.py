        ...
        for step, batch in enumerate(train_data_loader, start=1):
            ...
            if global_steps % args.save_steps == 0:
                if paddle.distributed.get_rank() == 0:
                    ...
                    logger.info(f"Save model at {global_steps} steps.\ndetection F1 = {det_f1}, correction F1 = {corr_f1}.")
...
if __name__ == "__main__":
    # CUDA_VISIBLE_DEVICES=1 python train.py --save_steps 10000 --extra_train_ds_dir ../data/cn/Wang271k
    do_train(args)
